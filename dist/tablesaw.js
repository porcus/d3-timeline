(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', 'exports', 'shoestring'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require('shoestring'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.shoestring);
		global.tablesaw = mod.exports;
	}
 ...
 * Copyright (c) 2017 Scott Jehl, Filament Group, Inc; Licensed MIT & GPLv2 */
   ...
   */
		function shoestring(prim, sec) {
			var pType = typeof prim === 'undefined' ? 'undefined' : _typeof(prim),
			    ret = [],
			    sel;
		...
		var Shoestring = function Shoestring(ret, prim) {
			this.length = 0;
			this.selector = prim;
   ...
   */
		shoestring.fn.bind = function (evt, data, originalCallback) {
			...
			function encasedCallback(e, namespace, triggeredElement) {
				...
				var preventDefaultConstructor = function preventDefaultConstructor() {
			...
			return this.each(function () {
				...
				for (var i = 0, il = evts.length; i < il; i++) {
					...
					domEventCallback = function domEventCallback(originalEvent) {
